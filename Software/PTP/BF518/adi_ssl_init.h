...
#define	BF_CORE_CLOCK		400		// cycle/sec
#define BF_SYSTEM_CLOCK_MHZ				80			//80MHz		
//#define BF_SYSTEM_CLOCK_CYCLE_NSEC		SEC_TO_NANOSEC/BF_SYSTEM_CLOCK_MHZ		// usec/cycle
...
***********************************************************************/
#if defined(__ADSP_MOCKINGBIRD__)  ||  defined(__ADSP_BRODIE__)       /* BF526 or BF512 EZKit */
