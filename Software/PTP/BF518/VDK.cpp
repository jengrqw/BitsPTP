...
namespace VDK
{
    ...
    VDK::ThreadTemplate    g_ThreadTemplates[] = 
    {
        ...
        INIT_THREADTEMPLATE_("kPtpd",kPriority5, 1024,  ::Ptpd_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false)
    };
...
HeapID g_IOObjectHeap = ksystem_heap;
    ...
    float g_ClockFrequency = 400000.000;

    unsigned int g_ClockPeriod = 40000;
